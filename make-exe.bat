...
"C:\Program Files (x86)\Windows Kits\10\bin\x64\signtool.exe" sign /a /s MY /n "Open Source Developer, Darren Richer" /t http://time.certum.pl /v "C:\test code\swon-analyzer.exe"
